...
<head>
    ...
    <style>
        ...
        .gradient-bg {
            background: linear-gradient(135deg, #FDE6B6 0%, #dfd3b9ff 50%, #FCECC4 100%);
        }
    </style>
</head>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-3xl shadow-2xl p-8 md:p-10">
            <div class="text-center mb-8">
                <div
                    class="w-16 h-16  items-center justify-center mx-auto mb-4">
                    <img src="{{ asset('icons/logo.png') }}" alt="Logo" class="w-full h-full object-contain">
                </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <button type="submit"
                    class="w-full bg-gradient-to-r from-amber-600 to-amber-700 text-white font-semibold py-3 px-4 rounded-xl hover:from-amber-700 hover:to-amber-800 transition-all duration-200 ">
                    Masuk
                </button>
            </form>
