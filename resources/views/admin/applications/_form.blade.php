                ...
                <div>
                    ...
                    <div class="flex items-center gap-2 mb-2">
                        <input type="text" id="theme_color" name="theme_color" value="{{ $currentColor }}" required
                            ...
                            class="w-28 px-3 py-2 border border-gray-200 rounded-lg text-base font-mono focus:ring-2 focus:ring-amber-400 focus:border-transparent outline-none @error('theme_color') border-red-300 @enderror"
    ...
    <div>
        ...
        <div class="relative">
            <input type="file" id="image" name="image" accept="image/*"
                class="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-base border border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-400 focus:border-transparent transition-all outline-none file:mr-3 file:py-1.5 file:px-3 sm:file:py-2 sm:file:px-4 file:rounded-lg file:border-0 file:bg-amber-50 file:text-amber-700 file:font-medium file:text-sm hover:file:bg-amber-100 @error('image') border-red-300 @enderror">
        </div>
